...
export function buildCertificateNftMintMetadata(
  ...
  return {
    ...
    attributes: {
      ...
      recipientName: truncateMetadataText(certificate.recipientName),
      recipientEmail: truncateMetadataText(certificate.recipientEmail ?? ''),
      recipientPosition: truncateMetadataText(certificate.recipientPosition),
      credentialType: truncateMetadataText(certificate.credentialType),
      issueDate: truncateMetadataText(certificate.issueDate),
      expiryDate: truncateMetadataText(certificate.expiryDate ?? ''),
      certificateHash: certificate.certificateHash,
      status: certificate.status,
    },
  };
